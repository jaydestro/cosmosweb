...
namespace cosmosweb.Services
{
    public class PartnerSession
    {
        public PartnerSessionSchedule GetPartnerSessions()
        {
            ...
            PartnerTechSession pt4 = new PartnerTechSession() { Date = new DateTime(2024, 09, 26, 09, 00, 00, 00, DateTimeKind.Utc), Title = "Cosmos DB - Mongo Migration", EmbedUri = "none", WatchUri = "none", Description = "In this session we will walk you through the assessment and Mongo Migration tools and help understand the approach of migration" };
