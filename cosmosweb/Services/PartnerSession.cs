...
namespace cosmosweb.Services
{
    public class PartnerSession
    {
        public PartnerSessionSchedule GetPartnerSessions()
        {
            ...
            PartnerTechSession pt3 = new PartnerTechSession() { Date = new DateTime(2024, 08, 29, 09, 00, 00, 00, DateTimeKind.Utc), Title = "GraphQL + Vector on Azure Cosmos DB", EmbedUri = "none", WatchUri = "none", Description = "In this session we will demonstrate & detail GraphSQL + Vector Search with Azure Cosmos DB" };
