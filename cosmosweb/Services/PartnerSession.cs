...
namespace cosmosweb.Services
{
    public class PartnerSession
    {
        ...
        {
            PartnerTechSession pt1 = new PartnerTechSession() { Date = new DateTime(2024, 06, 27, 09, 00, 00, 00, DateTimeKind.Utc), Title = "Retrieval-Augmented Generation (RAG) pattern for integrating Azure OpenAI services with custom data stored in Azure Cosmos DB NoSQL API", EmbedUri = "https://www.youtube.com/watch?v=E3okcKvpvHo", WatchUri = "https://www.youtube.com/watch?v=E3okcKvpvHo", Description = "Explore innovative ways to build robust applications using Azure Cosmos DB. Dive into an exciting demo that showcases the use of the Retrieval-Augmented Generation (RAG) pattern for integrating Azure OpenAI services with custom data stored in Azure Cosmos DB NoSQL API.\r\nIn this session, we'll demonstrate how to leverage a vector database within a NoSQL database to store, index, and query embeddings alongside their corresponding original data. This integration offers a streamlined solution, eliminating the need for a separate pure vector database and reducing extra costs associated with data replication.\r\nBy keeping the vector embeddings and original data together, we not only enhance data consistency but also enable seamless multi-modal data operations. This approach ensures superior scale and performance, allowing your applications to harness the full potential of both structured and unstructured data." };
            PartnerTechSession pt2 = new PartnerTechSession() { Date = new DateTime(2024, 07, 25, 09, 00, 00, 00, DateTimeKind.Utc), Title = "RAG Pattern with Mongo vCore", EmbedUri = "", WatchUri = "", Description = "In this session Avijit talks through MongoDB vCore offering and its advantages with demonstration of RAG." };
            PartnerTechSession pt3 = new PartnerTechSession() { Date = new DateTime(2024, 08, 29, 09, 00, 00, 00, DateTimeKind.Utc), Title = "Security & Compliance with Cosmos DB", EmbedUri = "none", WatchUri = "none", Description = "In this session we will brief about the security features and compliances of Azure Cosmos DB" };
            PartnerTechSession pt4 = new PartnerTechSession() { Date = new DateTime(2024, 09, 26, 09, 00, 00, 00, DateTimeKind.Utc), Title = "Cosmos DB - GraphQL capabilities", EmbedUri = "none", WatchUri = "none", Description = "In this session we will demonstrate the GraphQL capabilities of Azure Cosmos DB" };
            PartnerTechSession pt5 = new PartnerTechSession() { Date = new DateTime(2024, 10, 31, 09, 00, 00, 00, DateTimeKind.Utc), Title = "Cosmos DB - Mongo Migration", EmbedUri = "none", WatchUri = "none", Description = "In this session we will walk you through the assessment and Mongo Migration tools and help understand the approach of migration" };
